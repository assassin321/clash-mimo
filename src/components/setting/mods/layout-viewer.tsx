      ...
      <List>
        {show_title_setting && (
          <ListItem className="px-0.5 py-[5px]">
            ...
            <GuardState
              ...
              onGuard={async (e) => {
                await patchMimo({ enable_system_title_bar: e });
        ...
        {OS === "macos" && (
          <ListItem className="px-0.5 py-[5px]">
            ...
            <GuardState
              ...
              onCatch={onError}
              onFormat={onSwitchFormat}
              onGuard={(e) => patchMimo({ keep_in_dock: e })}>
              <SwitchLovely edge="end" />
            </GuardState>
          </ListItem>
        )}
        ...
        <ListItem className="px-0.5 py-[5px]">
          ...
          <GuardState
            ...
            onCatch={onError}
            onFormat={onSwitchFormat}
            onGuard={(e) => patchMimo({ enable_keep_ui_active: e })}>
            <SwitchLovely edge="end" />
          </GuardState>
        </ListItem>
        <ListItem className="px-0.5 py-[5px]">
          ...
          <GuardState
            ...
            onCatch={onError}
            onFormat={onSwitchFormat}
            onGuard={(e) => patchMimo({ traffic_graph: e })}>
            <SwitchLovely edge="end" />
          </GuardState>
        </ListItem>
        ...
        <ListItem className="px-0.5 py-[5px]">
          ...
          <GuardState
            ...
            onCatch={onError}
            onFormat={onSwitchFormat}
            onGuard={(e) => patchMimo({ enable_memory_usage: e })}>
            <SwitchLovely edge="end" />
          </GuardState>
        </ListItem>
        ...
        <ListItem className="px-0.5 py-[5px]">
          ...
          <GuardState
            ...
            onCatch={onError}
            onFormat={onSwitchFormat}
            onGuard={(e) => patchMimo({ enable_group_icon: e })}>
            <SwitchLovely edge="end" />
          </GuardState>
        </ListItem>
        ...
        <ListItem className="px-0.5 py-[5px]">
          ...
          <GuardState
            ...
            onGuard={(e) => patchMimo({ menu_icon: e })}>
        ...
        <ListItem className="px-0.5 py-[5px]">
          ...
          <GuardState
            ...
            onCatch={onError}
            onFormat={onSwitchFormat}
            onGuard={(e) => patchMimo({ enable_tray: e })}>
            <SwitchLovely edge="end" />
          </GuardState>
        </ListItem>
        ...
        {OS === "macos" && (
          <ListItem className="px-0.5 py-[5px]">
            ...
            <GuardState
              ...
              onCatch={onError}
              onFormat={(e: any) => e.target.value}
              onGuard={(e) => patchMimo({ tray_icon: e })}>
              <Select
                size="small"
        ...
        <ListItem className="px-0.5 py-[5px]">
          ...
          <GuardState
            ...
            onCatch={onError}
            onGuard={(e) => patchMimo({ common_tray_icon: e })}>
            <Button
              variant="outlined"
              size="small"
              startIcon={
              ...
              onClick={async () => {
                if (commonTrayIcon) {
                  patchMimo({ common_tray_icon: false });
                } else {
                  ...
                  if (path?.length) {
                    ...
                    await initIconPath();
                    patchMimo({ common_tray_icon: true });
                  }
                }
              }}>
              {commonTrayIcon
        ...
        <ListItem className="px-0.5 py-[5px]">
          ...
          <GuardState
            ...
            onCatch={onError}
            onGuard={(e) => patchMimo({ sysproxy_tray_icon: e })}>
            <Button
              variant="outlined"
              size="small"
              startIcon={
              ...
              onClick={async () => {
                if (sysproxyTrayIcon) {
                  patchMimo({ sysproxy_tray_icon: false });
                } else {
                  const path = await openDialog({
                    directory: false,
                    multiple: false,
                  ...
                  if (path?.length) {
                    ...
                    await initIconPath();
                    patchMimo({ sysproxy_tray_icon: true });
                  }
                }
              }}>
              {sysproxyTrayIcon
        ...
        <ListItem className="px-0.5 py-[5px]">
          ...
          <GuardState
            value={tunTrayIcon}
            onCatch={onError}
            onGuard={(e) => patchMimo({ tun_tray_icon: e })}>
            <Button
              variant="outlined"
              size="small"
              startIcon={
