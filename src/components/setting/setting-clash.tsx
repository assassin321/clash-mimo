    ...
    <SettingList title={t("pages.settings.clash.title")}>
      ...
      <SettingItem
        ...
        <GuardState
          ...
          onCatch={onError}
          onFormat={onSwitchFormat}
          // onChange={(e) => onChangeMimo({ enable_service_mode: e })}
          onGuard={(e) => patchMimo({ enable_service_mode: e })}
        ...
        extra={
          <Tooltip title={t("pages.settings.clash.portConfig.randomPort")}>
            <IconButton
              ...
              size="small"
              onClick={() => {
                patchMimo({ enable_random_port: !enableRandomPort });
      ...
      <SettingItem
        ...
        <GuardState
          ...
          onCatch={onError}
          onFormat={onSwitchFormat}
          onGuard={(e) => patchMimo({ enable_external_controller: e })}>
          <SwitchLovely edge="end" />
        </GuardState>
      </SettingItem>
