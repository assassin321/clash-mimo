...
export type ThemeSetting = NonNullable<IMimoThemeSettings>;
...
interface ThemeSettings {
  light: IMimoThemeSettings;
  dark: IMimoThemeSettings;
  currentTheme?: string;
}

export const isSameThemeColors = (
  left: IMimoThemeSettings,
  right: IMimoThemeSettings,
) =>
...
export const normalizeThemeSetting = (
  mode: ThemeMode,
  setting: IMimoThemeSettings | undefined,
) => {
  const fallback =
...
type ThemeSettingsActions = {
  setLightThemeSetting: (setting: IMimoConfig["theme_setting"]) => void;
  setDarkThemeSetting: (setting: IMimoConfig["theme_setting"]) => void;
  setThemeColor: (mode: ThemeMode, key: ThemeKey, value: string) => void;
  resetLightThemeSetting: () => void;
  resetDarkThemeSetting: () => void;
  syncThemeSettings: (verge: IMimoConfig) => void;
