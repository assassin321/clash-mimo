...
function SettingPage() {
  ...
  const GithubIcon = () => {
    const toGithubRepo = useLockFn(() => {
      return openThat('https://github.com/assassin321/clash-mimo')
    })

    return (
      <IconButton
        color="inherit"
        title="@assassin321/clash-mimo"
  ...
  const FeedbackIcon = () => {
    const toFeedback = useLockFn(async () => {
      ...
      return openThat(
        'https://github.com/assassin321/clash-mimo/issues/new?assignees=&labels=T%3A+Bug%2CS%3A+Untriaged&projects=&template=bug_report.yaml&env_infos=' +
          formattedEnv,
      )
    })
    return (
