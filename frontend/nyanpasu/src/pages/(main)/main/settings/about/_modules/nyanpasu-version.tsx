...
const TITLE = 'Clash Mimo'

const GITHUB_RELEASES_URL =
  'https://github.com/assassin321/clash-mimo/releases'
...
const NewVersionModal = ({ children }: PropsWithChildren) => {
  ...
  //   ? `https://github.com/assassin321/clash-mimo/releases/tag/pre-release`
  //   : `https://github.com/assassin321/clash-mimo/releases/tag/v${newVersion?.version}`
