...
/**
 * Mimo backend event name, use tauri event api to listen this event
 */
...
/**
 * Mimo setting query key, used by useSettings hook
 */
export const NYANPASU_SETTING_QUERY_KEY = 'settings'

/**
 * Mimo system proxy query key, used by useSystemProxy hook
 */
export const NYANPASU_SYSTEM_PROXY_QUERY_KEY = 'system-proxy'

/**
 * Mimo chains log query key, fn: getPostProcessingOutput
 */
...
/**
 * Mimo profile query key, used to fetch profiles from query
 */
