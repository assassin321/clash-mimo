...
```shell
git clone https://github.com/assassin321/clash-mimo.git
cd clash-mimo
...
| `crates/clash-mimo-service` | Standalone sidecar service managing the Mihomo core process |
| `crates/clash-mimo-utils`   | Shared utility functions                                    |
