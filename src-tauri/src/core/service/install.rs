...
/// Install the Clash Mimo Service
...
pub async fn install_service() -> Result<()> {
    ...
    tracing::debug!("clash-mimo-service file path: {}", install_path.display());
    if !install_path.exists() {
        anyhow::bail!("clash-mimo-service file not found");
    }
...
pub async fn install_service() -> Result<()> {
    ...
    tracing::debug!("clash-mimo-service file path: {}", installer_path.display());
...
/// Uninstall the Clash Mimo Service
/// 该函数应该在协程或者线程中执行，避免UAC弹窗阻塞主线程
#[cfg(target_os = "windows")]
pub async fn uninstall_service() -> Result<()> {
    ...
    tracing::debug!("clash-mimo-service file path: {}", uninstall_path.display());
...
pub async fn uninstall_service() -> Result<()> {
    ...
    tracing::debug!("clash-mimo-service file path: {}", uninstaller_path.display());
