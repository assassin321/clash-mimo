...
use clash_mimo_utils::format_raw_mihomo_log_line;
...
const CLASH_CORES: [&str; 2] = ["clash-mihomo", "clash-mihomo-alpha"];
...
impl CoreManager {
    ...
    pub async fn run_core(&self) -> Result<()> {
        ...
        let clash_log_file = MimoLog::global().generate_clash_log_file()?;
