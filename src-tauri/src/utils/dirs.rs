...
pub static APP_ID: &str = "mimo.clash.app";
#[cfg(feature = "verge-dev")]
pub static APP_ID: &str = "mimo.clash.app.dev";
...
pub fn mihomo_pid_file() -> Result<PathBuf> {
    Ok(app_home_dir()?.join("clash-mihomo.pid"))
}
...
pub fn service_bin_path() -> Result<PathBuf> {
    ...
    let service_bin = format!("clash-mimo-service{}", exe_ext);
...
pub fn path_to_str(path: &PathBuf) -> Result<&str> {
    clash_mimo_utils::path_to_str(path)
}
