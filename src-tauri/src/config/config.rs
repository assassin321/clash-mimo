...
use super::{Draft, IClashConfig, IProfiles, IRuntime, IMimo};
use crate::{
    core::{service, sysopt},
    enhance,
    utils::{dirs, help},
...
pub const RUNTIME_CONFIG: &str = "clash-mimo.yaml";
pub const CHECK_CONFIG: &str = "clash-mimo-check.yaml";

pub struct Config {
    clash_config: Arc<Draft<IClashConfig>>,
    verge_config: Arc<Draft<IMimo>>,
...
impl Config {
    pub fn global() -> &'static Config {
        ...
        CONFIG.get_or_init(|| Config {
            ...
            verge_config: Arc::new(Draft::from(IMimo::new())),
    ...
    pub fn generate_file(config_type: ConfigType) -> Result<PathBuf> {
        ...
        help::save_yaml(&path, config, Some("# Generated by Clash Mimo"))?;
        Ok(path)
    }
    ...
    pub async fn reload() -> Result<()> {
        ...
        verge_config.clear_and_replace(IMimo::new());
        ...
        if old_enable_auto_launch != enable_auto_launch {
            verge_config.data_mut().patch_config(IMimo {
