...
pub const MIHOMO_SOCKET_PATH: &str = "/tmp/clash-mihomo.sock";
#[cfg(all(unix, feature = "verge-dev"))]
pub const MIHOMO_SOCKET_PATH: &str = "/tmp/clash-mihomo-dev.sock";

#[cfg(all(windows, not(feature = "verge-dev")))]
pub const MIHOMO_SOCKET_PATH: &str = r"\\.\pipe\clash-mihomo";
#[cfg(all(windows, feature = "verge-dev"))]
pub const MIHOMO_SOCKET_PATH: &str = r"\\.\pipe\clash-mihomo-dev";
