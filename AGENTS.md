...
**Clash Mimo** is a Tauri v2 desktop GUI for [Mihomo](https://github.com/MetaCubeX/mihomo) (a proxy tool). It is a continuation of Clash Mimo with custom features. This repo is a fork of Clash Mimo Rev v1.6.0.
