...
#[cfg(not(feature = "verge-dev"))]
pub const APP_NAME: &str = "clash-mimo";
#[cfg(feature = "verge-dev")]
pub const APP_NAME: &str = "clash-mimo-dev";

/// App Dir placeholder
/// It is used to create the config and data dir in the filesystem
/// For windows, the style should be similar to `C:/Users/nyanapasu/AppData/Roaming/Clash Mimo`
/// For macos, it should be similar to `/Users/nyanpasu/Library/Application Support/Clash Mimo`
/// For other platforms, it should be similar to `/home/nyanpasu/.config/clash-mimo`
...
mod test {
    ...
    fn test_dir_placeholder() {
        ...
        if cfg!(windows) {
            assert_eq!(placeholder, "Clash Mimo");
        } else {
            assert_eq!(placeholder, "clash-mimo");
        }
    }
