...
!macro CheckAllNyanpasuProcesses
  ...
  !insertmacro CheckNyanpasuProcess "clash-mimo.exe" "2"
...
!macro StopCoreByService
  ; 构建服务可执行文件的完整路径
  StrCpy $1 "$ProgramDataPathVar\mimo-service\data\mimo-service.exe"
...
!macro StopAndRemoveServiceDirectory
  ...
  RemoveDirectories:
    ...
    StrCpy $2 "$ProgramDataPathVar\mimo-service"
...
!macro RemoveRegs
  ...
  DeleteRegKey HKCU "Software\Classes\clash-mimo"
  DeleteRegKey HKCR "clash"
  DeleteRegKey HKCR "clash-mimo"
!macroend
